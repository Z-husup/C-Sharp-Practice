...
public static class LessonTasks
{
    ...
    public static void Task02_InsertExample(TaskSetup setup)
    {
        // TODO: Implement task.
        throw new NotImplementedException("Finish task using instructions above.");
    }

    // Task 3: RemoveExample
    ...
    public static void Task03_RemoveExample(TaskSetup setup)
    {
        // TODO: Implement task.
        throw new NotImplementedException("Finish task using instructions above.");
    }

    // Task 4: RemoveRangeExample
    // Goal: Implement remove/clear logic and verify final state.
    // Implementation Steps:
    // 1) Initialize data from setup.
    // 2) Run removal operation.
    ...
    // Input/Data to use: Use setup.NumberList = [1,2,3,4,5]
    // Expected Output/Checks: Expected: removed values are absent and count is correct.
    public static void Task04_RemoveRangeExample(TaskSetup setup)
    {
        // TODO: Implement task.
        throw new NotImplementedException("Finish task using instructions above.");
    }

    // Task 5: CountCapacityExample
    ...
    public static void Task05_CountCapacityExample(TaskSetup setup)
    {
        // TODO: Implement task.
        throw new NotImplementedException("Finish task using instructions above.");
    }
